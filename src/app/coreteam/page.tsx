...
export default function People() {
  const [convenors, setConvenors] = useState<Convenors[]>([]);
  const [chiefConvenor, setChiefConvenor] = useState<ChiefConvenor[]>([]);
  const [coordinator, setCoordinator] = useState<Coordinator[]>([]);

  useEffect(() => {
    setConvenors(convenorsData);
    setChiefConvenor(chiefConvenorData);
